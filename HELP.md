...
* The original package name 'it.pagopa.cstar.io-mock' is invalid and this project uses 'it.pagopa.cstar.iomock' instead.
...
```
$ docker run --rm io-mock:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/io-mock
```
